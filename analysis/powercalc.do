...
cd "/Users/Heymans/Library/CloudStorage/OneDrive-UCL/PhD/2025-TSS awards" 																			//SPECIFY - working directory
...
local sample_size = 5000															//SPECIFY - sample size
local effect = 0.1																//SPECIFY - hypothesized treatment effect
...
while `it' <=`sims'{
		...
		drawnorm error, m(0) sd(0.45)												//SPECIFY - the error is assumed to follow a standard normal but the researcher can decide the appropriate distribution for the sample population
